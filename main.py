...
########################################################################################################################
    ...
    pca_res2, pca_test2 = pca.pca(set2X_train, set2y_train, set2X_test, set2y_test, timestr, n=5, part='3', ds='Set2')
    ...
    #
    # # •	ICA
    ica_res1, ica_test1 = ica.ica(set1X_train, set1y_train, set1X_test, set1y_test, timestr, n=4, part='3', ds='Set1')
    ...
    rpg_res1, rpg_test1 = rp.grp(set1X_train, set1y_train, set1X_test, set1y_test, timestr, n=5, part='3', ds='Set1')
    rpg_res2, rpg_test2 = rp.grp(set2X_train, set2y_train, set2X_test, set2y_test, timestr, n=5, part='3', ds='Set2')
    ...
    rps_res1, rps_test1 = fs.srp(set1X_train, set1y_train, set1X_test, set1y_test, timestr, n=5, part='3', ds='Set1')
    rps_res2, rps_test2 = fs.srp(set2X_train, set2y_train, set2X_test, set2y_test, timestr, n=5, part='3', ds='Set2')
    ...
    nn.NN(set2X_train, set2X_test, set2y_train, set2y_test, timestr, part='5', ds='Set2_original', final=True,hidden_layer_sizes=(50,100,50), alpha=0.05)

    #
    # # pca_res2, pca_test2
    pca_res2, pca_test2 = pca.pca(set2X_train, set2y_train, set2X_test, set2y_test, timestr, n=5, part='3', ds='Set2')
    nn.NN(pca_res2, pca_test2, set2y_train, set2y_test, timestr, part='4', ds='Set2_PCA')
    nn.NN(pca_res2, pca_test2, set2y_train, set2y_test, timestr, part='4', ds='Set2_PCA', final=True,hidden_layer_sizes=(50,50,50), alpha=0.1)
    #
    # # ica_res2, ica_test2
    ica_res2, ica_test2 = ica.ica(set2X_train, set2y_train, set2X_test, set2y_test, timestr, n=5, part='3', ds='Set2')
    nn.NN(ica_res2, ica_test2, set2y_train, set2y_test, timestr, part='4', ds='Set2_ICA')
    nn.NN(ica_res2, ica_test2, set2y_train, set2y_test, timestr, part='4', ds='Set2_ICA', final=True,hidden_layer_sizes=(50,50,50), alpha=0.05)
    #
    # # rpg_res2, rpg_test2
    rpg_res2, rpg_test2 = rp.grp(set2X_train, set2y_train, set2X_test, set2y_test, timestr, n=5, part='3', ds='Set2')
    nn.NN(rpg_res2, rpg_test2, set2y_train, set2y_test, timestr, part='4', ds='Set2_RPG')
    nn.NN(rpg_res2, rpg_test2, set2y_train, set2y_test, timestr, part='4', ds='Set2_RPG', final=True,hidden_layer_sizes=(50,100,50), alpha=0.1)
    #
    # rps_res2, rps_test2
    rps_res2, rps_test2 = fs.srp(set2X_train, set2y_train, set2X_test, set2y_test, timestr, n=5, part='3', ds='Set2')
    nn.NN(rps_res2, rps_test2, set2y_train, set2y_test, timestr, part='4', ds='Set2_RPS')
    nn.NN(rps_res2, rps_test2, set2y_train, set2y_test, timestr, part='4', ds='Set2_RPS', final=True,hidden_layer_sizes=(50,100), alpha=0.05)
    #
